...
"[project]/src/components/maintenance/inventory-management.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function InventoryManagement() {
    ...
    const handleExport = ()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$exportUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["exportToExcel"])(exportData, 'Inventory_Report');
    };
    ...
    const fetchInventory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InventoryManagement.useCallback[fetchInventory]": async ()=>{
            setIsLoading(true);
            setError(null);
            try {
                const { data, ok } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$proxy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiProxy"])('/api/inventory');
                if (ok) {
                    setInventory(data);
                } else {
    ...
    }["InventoryManagement.useCallback[fetchInventory]"], []);
    ...
    const handleSeed = async ()=>{
        ...
        setIsLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$proxy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiProxy"])('/api/inventory/seed', {
                method: 'POST'
            });
            fetchInventory();
        } catch (err_0) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const { data: data_0, ok: ok_0 } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$proxy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiProxy"])(url, {
                method,
            ...
            if (ok_0) {
                ...
                alert(data_0.message || 'Failed to save item');
            }
        } catch (err_1) {
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            const { ok: ok_1, data: data_1 } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$proxy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiProxy"])(`/api/inventory/${id}`, {
                method: 'DELETE'
            });
            if (ok_1) {
                fetchInventory();
            } else {
                alert(data_1.message || 'Failed to delete item');
            }
        } catch (err_2) {
            setError('Failed to delete item');
        }
    };
    const filteredInventory = inventory.filter((item_0)=>item_0.name.toLowerCase().includes(searchQuery.toLowerCase()) || item_0.category.toLowerCase().includes(searchQuery.toLowerCase()));
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                children: filteredInventory.map((item_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                className: "px-6 py-4 w-[15%]",
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: `px-2 py-1 rounded text-xs font-bold ${item_1.quantity < 5 ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`,
                                                    children: [
                                                        item_1.quantity,
                                                        " Units"
                                                    ]
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            onClick: ()=>handleDelete(item_1._id),
...
_s(InventoryManagement, "4qvc2FG8EbxvHA0SBnYPEZ+ikD4=");
...
//# sourceMappingURL=src_7e97b74c._.js.map